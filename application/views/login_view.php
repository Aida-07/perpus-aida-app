...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/B1.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a ="index.php" style="color: white;"><b> SELAMAT DATANG DI</b><br/> <b>PERPUSTAKAAN</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:15px solid Teal;">
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: white;"> Copyright &copy; Aida Yulianti - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
